...
// txouts.
func dbFetchSpendJournalEntry(dbTx database.Tx, block *cttutil.Block, view *UtxoViewpoint) ([]spentTxOut, error) {
...
func (b *BlockChain) createChainState() error {
	...
	genesisBlock := cttutil.NewBlock(b.chainParams.GenesisBlock)
...
// from the index, and return a cttutil.Block with the height set.
func dbFetchBlockByHash(dbTx database.Tx, hash *chainhash.Hash) (*cttutil.Block, error) {
...
// raw block for the provided height, deserialize it, and return a cttutil.Block
// with the height set.
func dbFetchBlockByHeight(dbTx database.Tx, height int32) (*cttutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHeight(blockHeight int32) (*cttutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*cttutil.Block, error) {
	var block *cttutil.Block
	err := b.db.View(func(dbTx database.Tx) error {
		var err error
