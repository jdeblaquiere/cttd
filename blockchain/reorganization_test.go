...
// cttutil.Block.  This is largely borrowed from the test code in cttdb.
func loadBlocks(filename string) (blocks []*cttutil.Block, err error) {
	...
	for height := int64(1); err == nil; height++ {
		...
		block, err = cttutil.NewBlockFromBytes(rbytes)
		if err != nil {
			return
		}
		blocks = append(blocks, block)
