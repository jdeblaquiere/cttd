...
const (
	...
	// generation rate.
	//targetTimespan = time.Hour * 24 * 14 // BTC default is 14 days
	targetTimespan = time.Hour * 2

	// targetSpacing is the desired amount of time to generate each block.
	//targetSpacing = time.Minute * 10 // BTC default is 10 minutes
	targetSpacing = time.Minute * 1
