...
/*
cttd is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means cttd will work 'out of
...
parsed when cttd starts up.  By default, the configuration file is located at
~/.cttd/cttd.conf on POSIX-style operating systems and %LOCALAPPDATA%\cttd\cttd.conf
