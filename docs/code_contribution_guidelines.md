...
reason, the cttd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire cttd
...
One of the major design goals of all core cttd packages is to aim for complete
...
contributions.  This is how to get your changes into cttd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/jadeblaquiere/cttd/graphs/contributors)!
...
[ISC license](https://github.com/jadeblaquiere/cttd/blob/master/LICENSE).  This is
the same license as all of the code in the cttd suite.
