...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*cttutil.Block, error) {
	...
	blocks := make([]*cttutil.Block, 0, 256)
	genesis := cttutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
